...
const FileCard = ({file, onPreview, onShare, onRename, onMove, onDelete}) => {
  return (
      <div className="group relative bg-white border border-slate-200 hover:border-orange-200 rounded-2xl p-4
       transition-all duration-200 cursor-pointer flex flex-col justify-between">
          <div className="flex items-start justify-between gap-2 mb-3">
              ...
              <ItemDropdown item={file} onPreview={onPreview} onShare={onShare} onRename={onRename}
              onMove={onMove} onDelete={onDelete}></ItemDropdown>
          </div>
          <div>
